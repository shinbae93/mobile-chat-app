...
import com.midterm.realtimechatapp10.Adapter.MessageAdapter;
import com.midterm.realtimechatapp10.Model.Chat;
...
//                    Toast.makeText(MessageActivity.this, userid, Toast.LENGTH_SHORT).show();
    ...
    private void sendMessage(String sender, final String receiver, String message) {
        DatabaseReference reference = FirebaseDatabase.getInstance("https://realtimechatapp-e6d03-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference();
//        if(reference != null) {
